...
offices = Office.create([ {title: 'President',        budget: 150, officer_id: 1, duties: "The President is the chief officer and the administrator of all club affairs. He serves as the representative to the university, and presides over both the officer and club meetings. Nominees for this office must have either previously served as an officer, or their nomination must receive majority approval from the current president, vice-president, and chaplain."},
                          {title: 'Vice President',   budget: 800, officer_id: 2, duties: "The Vice President is in charge of organizing and coordinating social events, Fall and Spring Banquets, and official club apparel. The Vice President is also responsible for the affairs of the club in the absence of the President."},
                          {title: 'Secretary',        budget: 200, officer_id: 5, duties: "The Secretary serves as the Editor-in-Chief of the club newsletter, The Knightly News, and is responsible for the distribution of said newsletter. He is also responsible for the publication and distribution of a club directory for the entire year, keeping accurate notes of all club meetings and voting results, and obtaining the club stationary."},
                          {title: 'Treasurer',        budget:   0, officer_id: 3, duties: "The Treasurer is responsible for collecting dues, handling all money transactions, and keeping an accurate record of the club's finances."},
                          {title: 'Chaplain',         budget: 150, officer_id: 7, duties: "The Chaplain is in charge of all devotionals that the club organizes. The Chaplain is also responsible for the spiritual guidance and personal development of the club and her members."},
                          {title: 'Social Service',   budget: 150, officer_id: 8, duties: "The Social Service Director is responsible for the planning and organizing of all social service events."},
                          {title: 'Athletic Director',budget:  50, officer_id: 6, duties: "The Athletic Director is responsible for organizing and coordinating all athletic events, appointing coaches, and assigning members to leagues. He or his proxy is required to attend all meetings called by the campus Intramural Director."},
                          {title: 'Historian',        budget: 150, officer_id: 9, duties: "The Historian is responsible for keeping a photographic record of various club activities, producing a year-end video and all alumni relations including Alpha's homecoming events."},
                          {title: 'Rush Director',    budget: 800, officer_id: 10, duties: "The Rush/PR Director is responsible for the recruitment of new members each Fall and Spring trimester. He is responsible for organizing and coordinating all Rush and recruitment activities including induction, knighting, the joust, and the feast.  It is recommended that the rush director be an individual who has participated in Fall rush.  He is also responsible for relations with other clubs, including but not limited to Unity for Spring Sing in the Spring."},
                          {title: 'Spring Sing',      budget: 800, officer_id: 4, duties: "The Spring Sing Director is responsible for producing a Spring Sing show. The Director is responsible for all aspects of the show such as costumes, choreography, music, etc."}
                        ])
