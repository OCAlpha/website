...
6. An active member directory with nicknames, bios, and privately-settable phone
       and email addresses
...
== Completed Features
* Officer Bios page that each officer can edit their own bio--All members have bios!
* A mobile version of the site--Designed with Responsive Twitter Bootstrap, mobile size supported by default

== Features in Development
* Prayer wall with follow-up capability that supports public and anonymous prayer requests
...
1. Verify permissions on all pages
2. Implement Payment/Charge/Purchase/Transfer confirmation for non-officers
3. Add features to Directory Page
4. Start implementing other planned features (details to be added to to-do list as features are implemented)
5. Get a private repository...
6. Offices and Budgets page: Treasurer totals depict collections outstanding instead of budgets
7. Accounts/show: list all transactions involving that account